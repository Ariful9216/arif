...
import 'package:arif_mart/src/widget/offer_card.dart';
...
import 'controller/internet_screen_controller.dart';

class InternetOfferScreen extends StatelessWidget {
  InternetOfferScreen({super.key});

  final controller = Get.put(InternetOfferController());
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Internet Offer', style: TextStyle(color: Colors.white)),
        ),
        body: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              ...
              // Internet Offer Slider - Replaces static image
              Obx(
                () =>
                              ...
                              : RefreshIndicator(
                                ...
                                ? ListView.builder(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Center(child: Text("No Offer Available", style: TextStyle(color: AppColors.primaryColor))),
                                  ),
                                ),
                              ),
                    ),
                                        ...
                                        : SingleChildScrollView(
                                          ...
                                          child: SizedBox(
                                            height:
                                                ...
                                                kToolbarHeight - // adjust if you have custom app bar
                                                MediaQuery.of(context).padding.top,
                                            child: Center(child: Text("No Pending Offer Available", style: TextStyle(color: AppColors.primaryColor))),
                                          ),
                                        ),
                              ),
                    ),
                                        ...
                                        : SingleChildScrollView(
                                          ...
                                          child: SizedBox(
                                            height:
                                                ...
                                                kToolbarHeight - // adjust if you have custom app bar
                                                MediaQuery.of(context).padding.top,
                                            child: Center(child: Text("No History Offer Available", style: TextStyle(color: AppColors.primaryColor))),
                                          ),
                                        ),
                              ),
                    ),
