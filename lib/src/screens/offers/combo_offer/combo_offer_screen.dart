...
import '../../../widget/build_search_field.dart' show buildSearchField;
...
class ComboOfferScreen extends StatelessWidget {
  ComboOfferScreen({super.key});

  final controller = Get.put(ComboOfferController());
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Combo Offer', style: TextStyle(color: Colors.white)),
        ),
        body: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              ...
              // Combo Offer Slider - Replaces static image
              Obx(
                () =>
                            ...
                            children:
                                controller.isOperatorsLoading.value
                                    ...
                                    : List.generate(controller.operatorModel.data.length, (index) {
                                      // return operatorIcon(controller.operatorModel.value.data[index].image);
                                      return InkWell(
                                        onTap: () {
                    ...
                    Obx(
                      () =>
                          controller.isOffersLoading.value
                            ...
                            onRefresh: () async {
                              Get.log("selectedOperators = ${controller.selectedOperators.value}");
                              ...
                              controller.getSliders(); // Refresh sliders too
                                ...
                                ? ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    colorTheme: AppColors.appBarColor2,
                                    onTap: () async {
                                ...
                                : SingleChildScrollView(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Center(child: Text("No Offer Available", style: TextStyle(color: AppColors.appBarColor2))),
                                  ),
                                ),
                              ),
                    ),
                                        ...
                                        : SingleChildScrollView(
                                          ...
                                          child: SizedBox(
                                            height:
                                                ...
                                                kToolbarHeight - // adjust if you have custom app bar
                                                MediaQuery.of(context).padding.top,
                                            child: Center(child: Text("No Pending Offer Available", style: TextStyle(color: AppColors.appBarColor2))),
                                          ),
                                        ),
                              ),
                    ),
                                        ...
                                        : SingleChildScrollView(
                                          ...
                                          child: SizedBox(
                                            height:
                                                ...
                                                kToolbarHeight - // adjust if you have custom app bar
                                                MediaQuery.of(context).padding.top,
                                            child: Center(child: Text("No History Offer Available", style: TextStyle(color: AppColors.appBarColor2))),
                                          ),
                                        ),
                              ),
                    ),
